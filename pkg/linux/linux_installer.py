...
bash = 'bash -c \"echo INSTALLING BITBLOQS WEB2BOARD. DO NOT CLOSE; sudo {} onTerminal; exec bash\"'.format(sys.argv[0])

if len(sys.argv) <= 1 or sys.argv[1] != "onTerminal":
    ...
    if __name__ == '__main__':
        ...
        try:
            ...
            log.info("executed factoryReset")
        except:
            if log:
