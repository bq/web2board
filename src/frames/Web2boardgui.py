...
class Web2boardGui(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"Web2board", pos=wx.DefaultPosition,
                          size=wx.Size(726, 375), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL,
                          name=u"Web2boardMain")
        ...
        self.portCombo = wx.ComboBox(self.mainPanel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(120, -1),
                                     portComboChoices, wx.CB_DROPDOWN | wx.CB_SORT)
        bSizer2.Add(self.portCombo, 0, wx.ALL | wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL, 5)

        # self.resfreshPortsButton = wx.BitmapButton(self.mainPanel, wx.ID_ANY,
        #                                            wx.Bitmap(u"res/icons/refresh-icon.png", wx.BITMAP_TYPE_ANY),
        ...
        self.consoleLog = wx.html.HtmlWindow(self.mainPanel, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
