...
class Window(QtGui.QDialog):
    ...
    def createIconGroupBox(self):
        ...
        self.iconComboBox.addItem(QtGui.QIcon('res/Web2board.ico'), "Bad")
        self.iconComboBox.addItem(QtGui.QIcon('res/Web2board.ico'), "Heart")
        self.iconComboBox.addItem(QtGui.QIcon('res/Web2board.ico'), "Trash")
